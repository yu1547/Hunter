...
data class BackpackItem(val itemId: String, val quantity: Int)
...
data class HaveCheckPlaces(val spotId: String, val isCheck: Boolean)

data class SpotScanLogs(val isCheck: Boolean = false)
...
data class Buff(val isBuff: Int = 0)
