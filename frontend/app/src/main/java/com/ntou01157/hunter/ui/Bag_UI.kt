                        ...
                        LazyVerticalGrid(
                            ...
                            items(filteredItems) { userItem ->
                                Box(
                                    ...
                                    //     Log.e("BagScreen", "Invalid imageResId for item:
                                    // ${userItem.item.itemName} (pic: ${userItem.item.itemPic})")
                                    // }
                                    Image(
                                            painter =
                                                    painterResource(
                                                            id = R.drawable.default_itempic
                                                    ), // 之後要記得改成imageResId，而且要把上面註解取消
                ...
                AlertDialog(
                        ...
                        title = {
                            Box(Modifier.fillMaxWidth()) {
                                ...
                                Text(
                                        "✕",
                                        modifier =
                                                Modifier.align(Alignment.TopEnd).clickable {
                        ...
                        text = {
                            ...
                            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                                ...
                                //     Log.e("BagScreen", "Invalid imageResId for resultItem:
                                // ${resultItem.item.itemName} (pic: ${resultItem.item.itemPic})")
                                // }
                                Image(
                                        painter =
                                                painterResource(
                                                        id = R.drawable.default_itempic
                                                ), // 之後要記得改成resultImageResId，而且要把上面註解取消
                                ...
                                Row(
                                    ...
                                    selectedItem?.let { material ->
                                        Column(horizontalAlignment = Alignment.CenterHorizontally) {
                                            ...
                                            // {
                                            //     Log.e("BagScreen", "Invalid imageResId for
                                            // selected material: ${material.item.itemName} (pic:
                                            // ${material.item.itemPic})")
                                            // }
                                            Image(
                                                    painter =
                                                            painterResource(
                            ...
                            Button(
                                    onClick = {
                                        coroutineScope.launch {
                                            ...
                                            val hasEnoughMaterials =
                                                    requiredMaterials.all { material ->
                                                        allItems.any { userItem ->
                                                            userItem.item.itemId ==
                                                                    material.item.itemId &&
                                                                    userItem.count.value >= 1
                                                        }
                                                    }
            ...
            AlertDialog(
                    ...
                    text = {
                        Column(
                            ...
                            // val imageResId = getDrawableId(userItem.item.itemPic)
                            // if (imageResId == R.drawable.ic_placeholder) {
                            //     Log.e("BagScreen", "Invalid imageResId for detail view item:
                            // ${userItem.item.itemName} (pic: ${userItem.item.itemPic})")
                            // }
                            Image(
                                    painter =
